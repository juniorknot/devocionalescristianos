...
<meta property="og:title" content="Salmos 137 CAB - Biblia Castilian 2003"/>
<meta property="og:description" content="Capítulo A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión.All, en los sauces, hab amos colgado nuestras liras, - Biblia Castilian 2003"/>
...
.com">
<meta name="twitter:title" content="Salmos 137 CAB - Biblia Castilian 2003">
<meta name="twitter:description" content="Capítulo A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión.All, en los sauces, hab amos colgado nuestras liras, - Biblia Castilian 2003">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión.All, en los sauces, hab amos colgado nuestras liras, - Biblia Castilian 2003" name="description"/>
<?php } ?>

<!-- /la-biblia/Castilian-2003/salmos-137 , Wed, 28 Dec 2016 21:40:19 GMT -->
<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" lang='es'>

<!-- /la-biblia/Castilian-2003/salmos-137 , Wed, 28 Dec 2016 21:40:18 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión.All, en los sauces, hab amos colgado nuestras liras, - Biblia Castilian 2003",
  "url": "../../la-biblia/Castilian-2003/salmos-137",
...
<li title="PDF de Salmos 137"><a title="PDF de Salmos 137" target="_blank" href="../../imprimir/Castilian-2003/salmos-137.pdf"><span class="icon-file-pdf-o"></span></a></li>
<li title="Comentario Bíblico de Salmos 137"><a href="../../comentario-biblico/?v=CAB&amp;co=matthew-henry&amp;l=salmos&amp;cap=137" target="_blank"><span class="icon-book"></span></a></li>
<li id="shareButtonPrint" title="Imprimir Salmos 137"><a target="_blank" onclick='PrintElem("Salmos_137_Biblia Castilian 2003")' class="icon-print"></a></li>
</ul>
<ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden">
 
<li class="hide-for-large"><a href="whatsapp://send?text=Salmos 137 (CAB)%0A%0A 1. A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión. 2. All, en los sauces, hab amos colgado nuestras liras, 3. pues que all nos ped an cantos nuestros carceleros, nuestros verdugos alegr a: "¡Cantad para nosotros un canto de Sión!". 4. ¡Cómo cantar los cantos del Se or en una tierra extra a! 5. Si de ti, Jerusalén, yo me olvidara, quede paralizada mi diestra; 6. que se pegue mi lengua al paladar, si de ti no me acordara, si a Jerusalén yo no pusiera por colmo de mis gozos. 7. A los hijos de Edom tenles, Se or, en cuenta el d a de Jerusalén, cuando dec an: "¡Desnudadla, desnudadla, hasta sus mismos cimientos!". 8. ¡Capital de Babel devastadora, bendito el que te pague como a nosotros tú has pagado! 9. ¡Bendito el que agarre y estrelle contra la roca a tus peque os!... %0A%0Ahttp://bt3.me/bmeO"><span class="icon-whatsapp"></span> WHATSAPP</a></li>
                                <li class="hide-for-large"><a href="bbmi://api/share?message=devocionales
&userCustomMessage=Salmos 137 (CAB)%0A%0A
 A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión. 
 All, en los sauces, hab amos colgado nuestras liras, ... %0A%0Ahttp://bt3.me/bmeO"><span class="icon-group"></span> BLACKBERRY</a></li>
                                <li class="hide-for-large"><a href="sms:?&body=Salmos 137 CAB - Biblia Castilian 2003%0A%0A 1. A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión. 2. All, en los sauces, hab amos colgado nuestras liras, 3. pues que all nos ped an cantos nuestros carceleros, nuestros verdugos alegr a: "¡Cantad para nosotros un canto de Sión!". 4. ¡Cómo cantar los cantos del Se or en una tierra extra a! 5. Si de ti, Jerusalén, yo me olvidara, quede paralizada mi diestra; 6. que se pegue mi lengua al paladar, si de ti no me acordara, si a Jerusalén yo no pusiera por colmo de mis gozos. 7. A los hijos de Edom tenles, Se or, en cuenta el d a de Jerusalén, cuando dec an: "¡Desnudadla, desnudadla, hasta sus mismos cimientos!". 8. ¡Capital de Babel devastadora, bendito el que te pague como a nosotros tú has pagado! 9. ¡Bendito el que agarre y estrelle contra la roca a tus peque os! http://bt3.me/bmeO"><span class="icon-envelope-o"></span> SMS</a></li>
                              </ul>    
                             </div>
                        </div>
                    </div>  
...
?>                        <br />   
                        <h2 class="text-center"> Salmos 137 - Biblia Castilian 2003</h2>          
                                                    <h4><strong>Lamento de los cautivos en Babilonia</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">1. </strong>
 A la orilla de los r os de Babel estábamos sentados y llorábamos, recordando a Sión. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">2. </strong>
 All, en los sauces, hab amos colgado nuestras liras, </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">3. </strong>
 pues que all nos ped an cantos nuestros carceleros, nuestros verdugos alegr a: "¡Cantad para nosotros un canto de Sión!". </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">4. </strong>
 ¡Cómo cantar los cantos del Se or en una tierra extra a! </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">5. </strong>
 Si de ti, Jerusalén, yo me olvidara, quede paralizada mi diestra; </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">6. </strong>
 que se pegue mi lengua al paladar, si de ti no me acordara, si a Jerusalén yo no pusiera por colmo de mis gozos. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">7. </strong>
 A los hijos de Edom tenles, Se or, en cuenta el d a de Jerusalén, cuando dec an: "¡Desnudadla, desnudadla, hasta sus mismos cimientos!". </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">8. </strong>
 ¡Capital de Babel devastadora, bendito el que te pague como a nosotros tú has pagado! </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">9. </strong>
 ¡Bendito el que agarre y estrelle contra la roca a tus peque os! </p>
