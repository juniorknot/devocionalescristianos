...
<meta property="og:title" content="Mateo 4 SBVUJ - Biblia Universidad de Jerusalem"/>
<meta property="og:description" content="Capítulo Entonces Yeshúa fue llevado por el Espíritu al desierto para ser tentado por el diablo.Y después de hacer un ayuno de cuarenta días y cuarenta noches, al fin sintió hambre. - Biblia Universidad de Jerusalem"/>
...
.com">
<meta name="twitter:title" content="Mateo 4 SBVUJ - Biblia Universidad de Jerusalem">
<meta name="twitter:description" content="Capítulo Entonces Yeshúa fue llevado por el Espíritu al desierto para ser tentado por el diablo.Y después de hacer un ayuno de cuarenta días y cuarenta noches, al fin sintió hambre. - Biblia Universidad de Jerusalem">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo Entonces Yeshúa fue llevado por el Espíritu al desierto para ser tentado por el diablo.Y después de hacer un ayuno de cuarenta días y cuarenta noches, al fin sintió hambre. - Biblia Universidad de Jerusalem" name="description"/>
<?php } ?>

<!-- /la-biblia/Version-universidad-de-jerusalem/mateo-4 , Wed, 28 Dec 2016 15:40:31 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo Entonces Yeshúa fue llevado por el Espíritu al desierto para ser tentado por el diablo.Y después de hacer un ayuno de cuarenta días y cuarenta noches, al fin sintió hambre. - Biblia Universidad de Jerusalem",
  "url": "../../la-biblia/Version-universidad-de-jerusalem/mateo-4",
...
?>                        <br />   
                        <h2 class="text-center"> Mateo 4 - Biblia Universidad de Jerusalem</h2>          
                                                    <h4><strong>Tentación de Jesús</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">1. </strong>
 Entonces Yeshúa fue llevado por el Espíritu al desierto para ser tentado por el diablo. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">2. </strong>
 Y después de hacer un ayuno de cuarenta días y cuarenta noches, al fin sintió hambre. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">3. </strong>
 Y acercándose el tentador, le dijo: "Si eres Hijo de Di-s, di que estas piedras se conviertan en panes." </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">4. </strong>
 Mas él respondió: "Está escrito: = No sólo de pan vive el hombre, sino de toda palabra que sale de la boca de Di-s." = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">5. </strong>
 Entonces el diablo le lleva consigo a la Ciudad Santa, le pone sobre el alero del Templo, </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">6. </strong>
 y le dice: "Si eres Hijo de Di-s, tírate abajo, porque está escrito: = A sus ángeles te encomendará, y en sus manos te llevarán, para que no tropiece tu pie en piedra alguna." = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">7. </strong>
 Yeshúa le dijo: "También está escrito: = No tentarás al Señor tu Di-s." = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">8. </strong>
 Todavía le lleva consigo el diablo a un monte muy alto, le muestra todos los reinos del mundo y su gloria, </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">9. </strong>
 y le dice: "Todo esto te daré si postrándote me adoras." </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">10. </strong>
 Dícele entonces Yeshúa: "Apártate, Satán, porque está escrito: = Al Señor tu Di-s adorarás, y sólo a él darás culto." = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">11. </strong>
 Entonces el diablo le deja. Y he aquí que se acercaron unos ángeles y le servían. </p>
                                                    <h4><strong>Jesús principia su ministerio</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">12. </strong>
 Cuando oyó que Juan había sido entregado, se retiró a Galilea. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">13. </strong>
 Y dejando Nazará, vino a residir en Cafarnaúm junto al mar, en el término de Zabulón y Neftalí; </p>
 ...
 = ¡Tierra de Zabulón, tierra de Neftalí, camino del mar, allende el Jordán,Galilea de los gentiles! = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">16. </strong>
 = El pueblo que habitaba en tinieblas ha visto una gran luz; a los que habitaban en paraje de sombras de muerte una luz les ha amanecido. = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">17. </strong>
 Desde entonces comenzó Yeshúa a predicar y decir: "Convertios, porque el Reino de los Cielos ha llegado." </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">18. </strong>
 Caminando por la ribera del mar de Galilea vio a dos hermanos, Simón, llamado Pedro, y su hermano Andrés, echando la red en el mar, pues eran pescadores, </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">19. </strong>
 y les dice: "Venid conmigo, y os haré pescadores de hombres." </p>
 ...
 Caminando adelante, vio a otros dos hermanos, Santiago el de Zebedeo y su hermano Juan, que estaban en la barca con su padre Zebedeo arreglando sus redes; y los llamó. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">22. </strong>
 Y ellos al instante, dejando la barca y a su padre, le siguieron. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">23. </strong>
 Recorría Yeshúa toda Galilea, enseñando en sus sinagogas, proclamando la Buena Nueva del Reino y curando toda enfermedad y toda dolencia en el pueblo. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">24. </strong>
 Su fama llegó a toda Siria; y le trajeron todos los que se encontraban mal con enfermedades y sufrimientos diversos, endemoniados, lunáticos y paralíticos, y los curó. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">25. </strong>
 Y le siguió una gran muchedumbre de Galilea, Decápolis, Yerushalaim y Judea, y del otro lado del Jordán. </p>
