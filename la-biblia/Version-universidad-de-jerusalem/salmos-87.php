...
<meta property="og:title" content="Salmos 87 SBVUJ - Biblia Universidad de Jerusalem"/>
<meta property="og:description" content="Capítulo Su fundación sobre los santos montesama Adonai: las puertas de Sión más que todas las moradas de Jacob. - Biblia Universidad de Jerusalem"/>
...
.com">
<meta name="twitter:title" content="Salmos 87 SBVUJ - Biblia Universidad de Jerusalem">
<meta name="twitter:description" content="Capítulo Su fundación sobre los santos montesama Adonai: las puertas de Sión más que todas las moradas de Jacob. - Biblia Universidad de Jerusalem">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo Su fundación sobre los santos montesama Adonai: las puertas de Sión más que todas las moradas de Jacob. - Biblia Universidad de Jerusalem" name="description"/>
<?php } ?>

<!-- /la-biblia/Version-universidad-de-jerusalem/salmos-87 , Wed, 28 Dec 2016 23:56:15 GMT -->
<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" lang='es'>

<!-- /la-biblia/Version-universidad-de-jerusalem/salmos-87 , Wed, 28 Dec 2016 23:56:14 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo Su fundación sobre los santos montesama Adonai: las puertas de Sión más que todas las moradas de Jacob. - Biblia Universidad de Jerusalem",
  "url": "../../la-biblia/Version-universidad-de-jerusalem/salmos-87",
...
<li title="PDF de Salmos 87"><a title="PDF de Salmos 87" target="_blank" href="../../imprimir/Version-universidad-de-jerusalem/salmos-87.pdf"><span class="icon-file-pdf-o"></span></a></li>
<li title="Comentario Bíblico de Salmos 87"><a href="../../comentario-biblico/?v=SBVUJ&amp;co=matthew-henry&amp;l=salmos&amp;cap=87" target="_blank"><span class="icon-book"></span></a></li>
<li id="shareButtonPrint" title="Imprimir Salmos 87"><a target="_blank" onclick='PrintElem("Salmos_87_Biblia Universidad de Jerusalem")' class="icon-print"></a></li>
</ul>
<ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden">
 
<li class="hide-for-large"><a href="whatsapp://send?text=Salmos 87 (SBVUJ)%0A%0A 1. Su fundación sobre los santos montes 2. ama Adonai: las puertas de Sión más que todas las moradas de Jacob. 3. Glorias se dicen de ti, ciudad de Di-s: = Pausa. = 4. "Yo cuento a Ráhab y Babel entre los que me conocen.Tiro, Filistea y Etiopía, fulano nació allí." 5. Pero de Sión se ha de decir: "Todos han nacido en ella", y quien la funda es el propio Altísimo. 6. Adonai a los pueblos inscribe en el registro: "Fulano nació allí", = Pausa. = 7. y los príncipes, lo mismo que los hijos, todos ponen su mansión en ti.... %0A%0Ahttp://bt3.me/ZnU"><span class="icon-whatsapp"></span> WHATSAPP</a></li>
                                <li class="hide-for-large"><a href="bbmi://api/share?message=devocionales
&userCustomMessage=Salmos 87 (SBVUJ)%0A%0A
 Su fundación sobre los santos montes 
 ama Adonai: las puertas de Sión más que todas las moradas de Jacob. ... %0A%0Ahttp://bt3.me/ZnU"><span class="icon-group"></span> BLACKBERRY</a></li>
                                <li class="hide-for-large"><a href="sms:?&body=Salmos 87 SBVUJ - Biblia Universidad de Jerusalem%0A%0A 1. Su fundación sobre los santos montes 2. ama Adonai: las puertas de Sión más que todas las moradas de Jacob. 3. Glorias se dicen de ti, ciudad de Di-s: = Pausa. = 4. "Yo cuento a Ráhab y Babel entre los que me conocen.Tiro, Filistea y Etiopía, fulano nació allí." 5. Pero de Sión se ha de decir: "Todos han nacido en ella", y quien la funda es el propio Altísimo. 6. Adonai a los pueblos inscribe en el registro: "Fulano nació allí", = Pausa. = 7. y los príncipes, lo mismo que los hijos, todos ponen su mansión en ti. http://bt3.me/ZnU"><span class="icon-envelope-o"></span> SMS</a></li>
                              </ul>    
                             </div>
                        </div>
                    </div>  
...
?>                        <br />   
                        <h2 class="text-center"> Salmos 87 - Biblia Universidad de Jerusalem</h2>          
...
A los hijos de Coré. Salmo. Cántico.</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">1. </strong>
 Su fundación sobre los santos montes </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">2. </strong>
 ama Adonai: las puertas de Sión más que todas las moradas de Jacob. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">3. </strong>
 Glorias se dicen de ti, ciudad de Di-s: = Pausa. = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">4. </strong>
 "Yo cuento a Ráhab y Babel entre los que me conocen.Tiro, Filistea y Etiopía, fulano nació allí." </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">5. </strong>
 Pero de Sión se ha de decir: "Todos han nacido en ella", y quien la funda es el propio Altísimo. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">6. </strong>
 Adonai a los pueblos inscribe en el registro: "Fulano nació allí", = Pausa. = </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">7. </strong>
 y los príncipes, lo mismo que los hijos, todos ponen su mansión en ti. </p>
