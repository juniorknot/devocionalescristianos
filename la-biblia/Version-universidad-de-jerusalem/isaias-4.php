...
<meta property="og:title" content="Isaías 4 SBVUJ - Biblia Universidad de Jerusalem"/>
<meta property="og:description" content="Capítulo Asirán siete mujeres a un hombre en aquel día diciendo: "Nuestro pan comeremos, y con nuestras túnicas nos vestiremos.Tan sólo déjanos llevar tu nombre: quita nuestro oprobio."Aquel día el germen de Adonai será magnífico y glorioso, y el fruto de la tierra será la prez y ornato de los bien librados de Israel. - Biblia Universidad de Jerusalem"/>   
...
.com">
    <meta name="twitter:title" content="Isaías 4 SBVUJ - Biblia Universidad de Jerusalem">
    <meta name="twitter:description" content="Capítulo Asirán siete mujeres a un hombre en aquel día diciendo: "Nuestro pan comeremos, y con nuestras túnicas nos vestiremos.Tan sólo déjanos llevar tu nombre: quita nuestro oprobio."Aquel día el germen de Adonai será magnífico y glorioso, y el fruto de la tierra será la prez y ornato de los bien librados de Israel. - Biblia Universidad de Jerusalem">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
    <title> Isaías 4 SBVUJ - Biblia Universidad de Jerusalem </title>
    <meta content="Capítulo Asirán siete mujeres a un hombre en aquel día diciendo: "Nuestro pan comeremos, y con nuestras túnicas nos vestiremos.Tan sólo déjanos llevar tu nombre: quita nuestro oprobio."Aquel día el germen de Adonai será magnífico y glorioso, y el fruto de la tierra será la prez y ornato de los bien librados de Israel. - Biblia Universidad de Jerusalem" name="description" />
       
<?php } ?>

<!-- /la-biblia/Version-universidad-de-jerusalem/isaias-4 , Wed, 28 Dec 2016 15:40:21 GMT -->
<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" lang='es'>

<!-- /la-biblia/Version-universidad-de-jerusalem/isaias-4 , Wed, 28 Dec 2016 15:40:20 GMT -->
...
</div>     <script type="application/ld+json">
{
  ...
  "description": "Capítulo Asirán siete mujeres a un hombre en aquel día diciendo: "Nuestro pan comeremos, y con nuestras túnicas nos vestiremos.Tan sólo déjanos llevar tu nombre: quita nuestro oprobio."Aquel día el germen de Adonai será magnífico y glorioso, y el fruto de la tierra será la prez y ornato de los bien librados de Israel. - Biblia Universidad de Jerusalem",
  "url": "../../la-biblia/Version-universidad-de-jerusalem/isaias-4",
                        ...
                        <div class="small-12 columns" data-sticky-container>                                                                                       
                            <div class="large-12 columns compartir share-box sticky" data-options="marginTop:0;" data-sticky data-anchor="caja" data-sticky-on="small"> 
                               <ul class="menu simple">
                                ...
                                <li title="PDF de Isaías 4"><a title="PDF de Isaías 4" target="_blank" href="../../imprimir/Version-universidad-de-jerusalem/isaias-4.pdf"><span class="icon-file-pdf-o"></span></a></li>
                                <li title="Comentario Bíblico de Isaías 4"><a href="../../comentario-biblico/?v=SBVUJ&amp;co=matthew-henry&amp;l=isaias&amp;cap=4" target="_blank"><span class="icon-book"></span></a></li>
                              <li id="shareButtonPrint" title="Imprimir Isaías 4"><a target="_blank" onclick='PrintElem("Isaias_4_Biblia Universidad de Jerusalem")' class="icon-print"></a></li>
                              </ul>
                              <ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden