...
<meta property="og:title" content="Éxodo 27 NVI1984 - Nueva Version Internacional"/>
<meta property="og:description" content="Capítulo "Haz un altar de madera de acacia,  cuadrado,  de dos metros con treinta centímetros[1] por lado,  y de un metro con treinta centímetros[2] de alto.Ponle un cuerno en cada una de sus cuatro esquinas,  de manera que los cuernos y el altar formen una sola pieza,  y recubre de bronce el altar. - Nueva Version Internacional"/>   
...
.com">
    <meta name="twitter:title" content="Éxodo 27 NVI1984 - Nueva Version Internacional">
    <meta name="twitter:description" content="Capítulo "Haz un altar de madera de acacia,  cuadrado,  de dos metros con treinta centímetros[1] por lado,  y de un metro con treinta centímetros[2] de alto.Ponle un cuerno en cada una de sus cuatro esquinas,  de manera que los cuernos y el altar formen una sola pieza,  y recubre de bronce el altar. - Nueva Version Internacional">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
    <title> Éxodo 27 NVI1984 - Nueva Version Internacional </title>
    <meta content="Capítulo "Haz un altar de madera de acacia,  cuadrado,  de dos metros con treinta centímetros[1] por lado,  y de un metro con treinta centímetros[2] de alto.Ponle un cuerno en cada una de sus cuatro esquinas,  de manera que los cuernos y el altar formen una sola pieza,  y recubre de bronce el altar. - Nueva Version Internacional" name="description" />
       
<?php } ?>

<!-- /la-biblia/Nueva-version-internacional-1984/exodo-27 , Wed, 28 Dec 2016 21:48:02 GMT -->
...
</div>     <script type="application/ld+json">
{
  ...
  "description": "Capítulo "Haz un altar de madera de acacia,  cuadrado,  de dos metros con treinta centímetros[1] por lado,  y de un metro con treinta centímetros[2] de alto.Ponle un cuerno en cada una de sus cuatro esquinas,  de manera que los cuernos y el altar formen una sola pieza,  y recubre de bronce el altar. - Nueva Version Internacional",
  "url": "../../la-biblia/Nueva-version-internacional-1984/exodo-27",
...
?>                        <br />   
                        <h2 class="text-center"> Éxodo 27 - Nueva Version Internacional</h2>          
                                                    <h4><strong>El altar de bronce</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">1. </strong>
 "Haz un altar de madera de acacia,  cuadrado,  de dos metros con treinta centímetros[1] por lado,  y de un metro con treinta centímetros[2] de alto. </p>
 ...
 "Haz un atrio para el santuario.  El lado sur debe medir cuarenta y cinco metros[3] de largo,  y tener cortinas de lino fino, </p>
 ...
 "A todo lo ancho del lado occidental del atrio,  que debe medir veintidós metros y medio,[4] habrá cortinas,  diez postes y diez bases. </p>
 ...
 Habrá cortinas de siete metros[5] de largo,  y tres postes y tres bases a un lado de la entrada, </p>
 ...
 "A la entrada del atrio habrá una cortina de nueve metros[6] de largo,  de púrpura,  carmesí,  escarlata y lino fino,  recamada artísticamente,  y además cuatro postes y cuatro bases. </p>
 ...
 El atrio medirá cuarenta y cinco metros de largo por veintidós metros y medio de ancho,[7] con cortinas de lino fino de dos metros con treinta centímetros[8] de alto,  y con bases de bronce. </p>
 ...
 Aarón y sus hijos deberán mantenerlas encendidas toda la noche en presencia del Señor,  en la *Tienda de reunión,  fuera de la cortina que está ante el arca del *pacto.  Esta ley deberá cumplirse entre los israelitas siempre,  por todas las generaciones. </p>
