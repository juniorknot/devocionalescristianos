...
<meta property="og:title" content="Salmos 113 N-C - Nacar-Colunga"/>
<meta property="og:description" content="Capítulo ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé.Sea bendito el nombre de Yahvé desde ahora y por siempre. - Nacar-Colunga"/>
...
.com">
<meta name="twitter:title" content="Salmos 113 N-C - Nacar-Colunga">
<meta name="twitter:description" content="Capítulo ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé.Sea bendito el nombre de Yahvé desde ahora y por siempre. - Nacar-Colunga">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé.Sea bendito el nombre de Yahvé desde ahora y por siempre. - Nacar-Colunga" name="description"/>
<?php } ?>

<!-- /la-biblia/Nacar-colunga/salmos-113 , Wed, 28 Dec 2016 23:30:56 GMT -->
<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" lang='es'>

<!-- /la-biblia/Nacar-colunga/salmos-113 , Wed, 28 Dec 2016 23:30:55 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé.Sea bendito el nombre de Yahvé desde ahora y por siempre. - Nacar-Colunga",
  "url": "../../la-biblia/Nacar-colunga/salmos-113",
...
<li title="PDF de Salmos 113"><a title="PDF de Salmos 113" target="_blank" href="../../imprimir/Nacar-colunga/salmos-113.pdf"><span class="icon-file-pdf-o"></span></a></li>
<li title="Comentario Bíblico de Salmos 113"><a href="../../comentario-biblico/?v=N-C&amp;co=matthew-henry&amp;l=salmos&amp;cap=113" target="_blank"><span class="icon-book"></span></a></li>
<li id="shareButtonPrint" title="Imprimir Salmos 113"><a target="_blank" onclick='PrintElem("Salmos_113_Nacar-Colunga")' class="icon-print"></a></li>
</ul>
<ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden">
 
<li class="hide-for-large"><a href="whatsapp://send?text=Salmos 113 (N-C)%0A%0A 1. ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé. 2. Sea bendito el nombre de Yahvé desde ahora y por siempre. 3. Desde el levante del sol hasta su ocaso sea ensalzado el nombre de Yahvé. 4. Excelso sobre todas las gentes es Yahvé; su gloria es más alta que los cielos." 5. ¿Quién semejante a nuestro Dios, que tan alto se sienta 6. y se abaja para mirar en el cielo y en la tierra;" 7. que levanta del polvo al desvalido y alza del estiércol al pobre 8. para hacerle sentar entre los príncipes, entre los nobles de su pueblo;" 9. que hace habitar en casa a la estéril (como) madre gozosa de (numerosos) hijos? ¡Aleluya!... %0A%0Ahttp://bt3.me/b7eB"><span class="icon-whatsapp"></span> WHATSAPP</a></li>
                                <li class="hide-for-large"><a href="bbmi://api/share?message=devocionales
&userCustomMessage=Salmos 113 (N-C)%0A%0A
 ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé. 
 Sea bendito el nombre de Yahvé desde ahora y por siempre. ... %0A%0Ahttp://bt3.me/b7eB"><span class="icon-group"></span> BLACKBERRY</a></li>
                                <li class="hide-for-large"><a href="sms:?&body=Salmos 113 N-C - Nacar-Colunga%0A%0A 1. ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé. 2. Sea bendito el nombre de Yahvé desde ahora y por siempre. 3. Desde el levante del sol hasta su ocaso sea ensalzado el nombre de Yahvé. 4. Excelso sobre todas las gentes es Yahvé; su gloria es más alta que los cielos." 5. ¿Quién semejante a nuestro Dios, que tan alto se sienta 6. y se abaja para mirar en el cielo y en la tierra;" 7. que levanta del polvo al desvalido y alza del estiércol al pobre 8. para hacerle sentar entre los príncipes, entre los nobles de su pueblo;" 9. que hace habitar en casa a la estéril (como) madre gozosa de (numerosos) hijos? ¡Aleluya! http://bt3.me/b7eB"><span class="icon-envelope-o"></span> SMS</a></li>
                              </ul>    
                             </div>
                        </div>
                    </div>  
...
?>                        <br />   
                        <h2 class="text-center"> Salmos 113 - Nacar-Colunga</h2>          
                                                    <h4><strong>Dios levanta al pobre
Aleluya.</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">1. </strong>
 ¡Aleluya! Alabad, siervos de Yahvé, alabad el nombre de Yahvé. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">2. </strong>
 Sea bendito el nombre de Yahvé desde ahora y por siempre. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">3. </strong>
 Desde el levante del sol hasta su ocaso sea ensalzado el nombre de Yahvé. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">4. </strong>
 Excelso sobre todas las gentes es Yahvé; su gloria es más alta que los cielos." </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">5. </strong>
 ¿Quién semejante a nuestro Dios, que tan alto se sienta </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">6. </strong>
 y se abaja para mirar en el cielo y en la tierra;" </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">7. </strong>
 que levanta del polvo al desvalido y alza del estiércol al pobre </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">8. </strong>
 para hacerle sentar entre los príncipes, entre los nobles de su pueblo;" </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">9. </strong>
 que hace habitar en casa a la estéril (como) madre gozosa de (numerosos) hijos? ¡Aleluya! </p>
