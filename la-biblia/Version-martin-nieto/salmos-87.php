...
<meta property="og:title" content="Salmos 87 SBMN - Martin Nieto"/>
<meta property="og:description" content="Capítulo Salmo de los  hijos de Coré. Cánticoel Señor ama las  puertas de Sión más que todas las moradas  de Jacob. - Martin Nieto"/>
...
.com">
<meta name="twitter:title" content="Salmos 87 SBMN - Martin Nieto">
<meta name="twitter:description" content="Capítulo Salmo de los  hijos de Coré. Cánticoel Señor ama las  puertas de Sión más que todas las moradas  de Jacob. - Martin Nieto">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo Salmo de los  hijos de Coré. Cánticoel Señor ama las  puertas de Sión más que todas las moradas  de Jacob. - Martin Nieto" name="description"/>
<?php } ?>

<!-- /la-biblia/Version-martin-nieto/salmos-87 , Wed, 28 Dec 2016 23:57:27 GMT -->
<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" lang='es'>

<!-- /la-biblia/Version-martin-nieto/salmos-87 , Wed, 28 Dec 2016 23:57:26 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo Salmo de los  hijos de Coré. Cánticoel Señor ama las  puertas de Sión más que todas las moradas  de Jacob. - Martin Nieto",
  "url": "../../la-biblia/Version-martin-nieto/salmos-87",
...
<li title="PDF de Salmos 87"><a title="PDF de Salmos 87" target="_blank" href="../../imprimir/Version-martin-nieto/salmos-87.pdf"><span class="icon-file-pdf-o"></span></a></li>
<li title="Comentario Bíblico de Salmos 87"><a href="../../comentario-biblico/?v=SBMN&amp;co=matthew-henry&amp;l=salmos&amp;cap=87" target="_blank"><span class="icon-book"></span></a></li>
<li id="shareButtonPrint" title="Imprimir Salmos 87"><a target="_blank" onclick='PrintElem("Salmos_87_Martin Nieto")' class="icon-print"></a></li>
</ul>
<ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden">
 
<li class="hide-for-large"><a href="whatsapp://send?text=Salmos 87 (SBMN)%0A%0A 1. Salmo de los  hijos de Coré. Cántico 2. el Señor ama las  puertas de Sión más que todas las moradas  de Jacob. 3. ¡Qué cosas tan  hermosas se pregonan de  ti, ciudad de Dios! 4. Entre los que me  conocen citaré a Egipto y  Babilonia, Filistea, Tiro y Etiopía:  allí nacieron todos. 5. Se dirá de Sión: "Uno  a uno, todos han nacido  en ella, y el mismo altísimo es el  que la sostiene". 6. El Señor escribirá en  el registro de los  pueblos: "Éste ha nacido allí". 7. Y los que bailan  cantan a coro: "En ti están todas mis  fuentes".... %0A%0Ahttp://bt3.me/glir"><span class="icon-whatsapp"></span> WHATSAPP</a></li>
                                <li class="hide-for-large"><a href="bbmi://api/share?message=devocionales
&userCustomMessage=Salmos 87 (SBMN)%0A%0A
 Salmo de los  hijos de Coré. Cántico 
 el Señor ama las  puertas de Sión más que todas las moradas  de Jacob. ... %0A%0Ahttp://bt3.me/glir"><span class="icon-group"></span> BLACKBERRY</a></li>
                                <li class="hide-for-large"><a href="sms:?&body=Salmos 87 SBMN - Martin Nieto%0A%0A 1. Salmo de los  hijos de Coré. Cántico 2. el Señor ama las  puertas de Sión más que todas las moradas  de Jacob. 3. ¡Qué cosas tan  hermosas se pregonan de  ti, ciudad de Dios! 4. Entre los que me  conocen citaré a Egipto y  Babilonia, Filistea, Tiro y Etiopía:  allí nacieron todos. 5. Se dirá de Sión: "Uno  a uno, todos han nacido  en ella, y el mismo altísimo es el  que la sostiene". 6. El Señor escribirá en  el registro de los  pueblos: "Éste ha nacido allí". 7. Y los que bailan  cantan a coro: "En ti están todas mis  fuentes". http://bt3.me/glir"><span class="icon-envelope-o"></span> SMS</a></li>
                              </ul>    
                             </div>
                        </div>
                    </div>  
...
?>                        <br />   
                        <h2 class="text-center"> Salmos 87 - Martin Nieto</h2>          
...
A los hijos de Coré. Salmo. Cántico.</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">1. </strong>
 Salmo de los  hijos de Coré. Cántico </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">2. </strong>
 el Señor ama las  puertas de Sión más que todas las moradas  de Jacob. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">3. </strong>
 ¡Qué cosas tan  hermosas se pregonan de  ti, ciudad de Dios! </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">4. </strong>
 Entre los que me  conocen citaré a Egipto y  Babilonia, Filistea, Tiro y Etiopía:  allí nacieron todos. </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">5. </strong>
 Se dirá de Sión: "Uno  a uno, todos han nacido  en ella, y el mismo altísimo es el  que la sostiene". </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">6. </strong>
 El Señor escribirá en  el registro de los  pueblos: "Éste ha nacido allí". </p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">7. </strong>
 Y los que bailan  cantan a coro: "En ti están todas mis  fuentes". </p>
