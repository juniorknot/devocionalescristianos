...
<meta property="og:title" content="Zacarías 5 BLH - La Nueva Biblia Latinoamericana de Hoy"/>
<meta property="og:description" content="Capítulo Alcé de nuevo mis ojos y miré un rollo que volaba.Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codos (9 m) y su anchura de 10 codos (4.5 m)." - La Nueva Biblia Latinoamericana de Hoy"/>   
...
.com">
    <meta name="twitter:title" content="Zacarías 5 BLH - La Nueva Biblia Latinoamericana de Hoy">
    <meta name="twitter:description" content="Capítulo Alcé de nuevo mis ojos y miré un rollo que volaba.Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codos (9 m) y su anchura de 10 codos (4.5 m)." - La Nueva Biblia Latinoamericana de Hoy">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
    <title> Zacarías 5 BLH - La Nueva Biblia Latinoamericana de Hoy </title>
    <meta content="Capítulo Alcé de nuevo mis ojos y miré un rollo que volaba.Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codos (9 m) y su anchura de 10 codos (4.5 m)." - La Nueva Biblia Latinoamericana de Hoy" name="description" />
       
<?php } ?>

<!-- /la-biblia/biblia-latinoamericana-de-hoy/zacarias-5 , Wed, 28 Dec 2016 16:36:47 GMT -->
...
</div>     <script type="application/ld+json">
{
  ...
  "description": "Capítulo Alcé de nuevo mis ojos y miré un rollo que volaba.Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codos (9 m) y su anchura de 10 codos (4.5 m)." - La Nueva Biblia Latinoamericana de Hoy",
  "url": "../../la-biblia/biblia-latinoamericana-de-hoy/zacarias-5",
  "image": "../../assets/img/thumbs/capitulo/zacarias-5.jpg",
  "thumbnailUrl": "../../assets/img/thumbs/capitulo/zacarias-5.jpg"
}
</script>
                ...
                <td class="table_cap" title="Zacarías 4" onCLick="document.location='zacarias-4.php'">
                    <div data-sticky-container>
                       <div class="sticky" data-sticky data-options="marginTop:15;" data-sticky-on="small" data-anchor="caja">
                            <a href="zacarias-4.php" title="Zacarías 4"><span class="icon-chevron-left"></span></a>
                       </div>  
                    </div>                              
                </td>
                        ...
                        <div class="small-12 columns" data-sticky-container>                                                                                       
                            <div class="large-12 columns compartir share-box sticky" data-options="marginTop:0;" data-sticky data-anchor="caja" data-sticky-on="small"> 
                               <ul class="menu simple">
                                <li title="Compartir Zacarías 5" data-toggle="share-callout"> </li>
                                <li title="PDF de Zacarías 5"><a title="PDF de Zacarías 5" target="_blank" href="../../imprimir/biblia-latinoamericana-de-hoy/zacarias-5.pdf"><span class="icon-file-pdf-o"></span></a></li>
                                <li title="Comentario Bíblico de Zacarías 5"><a href="../../comentario-biblico/?v=BLH&amp;co=matthew-henry&amp;l=zacarias&amp;cap=5" target="_blank"><span class="icon-book"></span></a></li>
                              <li id="shareButtonPrint" title="Imprimir Zacarías 5"><a target="_blank" onclick='PrintElem("Zacarias_5_La Nueva Biblia Latinoamericana de Hoy")' class="icon-print"></a></li>
                              </ul>
                              <ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden">  
 
                                <li class="hide-for-large"><a href="whatsapp://send?text=Zacarías 5 (BLH)%0A%0A 1. Alcé de nuevo mis ojos y miré un rollo que volaba. 2. Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codos (9 m) y su anchura de 10 codos (4.5 m)." 3. Entonces me dijo: "Esta es la maldición que sale sobre la superficie de toda la tierra. Ciertamente todo el que roba será destruido según lo escrito en un lado, y todo el que jura será destruido según lo escrito en el otro lado. 4. "La haré salir," declara el SEÑOR de los ejércitos,"y entrará en casa del ladrón y en casa del que jura por Mi nombre en falso; y pasará la noche dentro de su casa y la consumirá junto con sus maderas y sus piedras." 5. Entonces el ángel que hablaba conmigo, salió y me dijo: "Alza ahora tus ojos y mira qué es esto que sale." 6. Y pregunté: "¿Qué es?" "Esto es el efa (una cesta de 22 litros) que sale," dijo él. Y añadió: "Esta es la iniquidad de ellos en toda la tierra." 7. "Entonces una tapa de plomo fue levantada, y había una mujer sentada dentro del efa (de la cesta). 8. Entonces dijo: "Esta es la Maldad." Y la arrojó al interior del efa (de la cesta) y arrojó la tapa de plomo sobre su abertura. 9. Luego alcé los ojos y miré dos mujeres que salían con el viento en sus alas. Tenían alas como alas de cigüeña, y alzaron el efa (la cesta) entre la tierra y el cielo. 10. Dije entonces al ángel que hablaba conmigo: "¿Adónde llevan el efa (la cesta)?" 11. Y él me respondió: "A la tierra de Sinar para edificarle un templo; y cuando esté preparado, será asentado allí sobre su base."... %0A%0Ahttp://bt3.me/gylg"><span class="icon-whatsapp"></span> WHATSAPP</a></li>
                                <li class="hide-for-large"><a href="bbmi://api/share?message=devocionales
&userCustomMessage=Zacarías 5 (BLH)%0A%0AAlcé de nuevo mis ojos y miré un rollo que volaba.Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codo... %0A%0Ahttp://bt3.me/gylg"><span class="icon-group"></span> BLACKBERRY</a></li>
                                <li class="hide-for-large"><a href="sms:?&body=Zacarías 5 BLH - La Nueva Biblia Latinoamericana de Hoy%0A%0A 1. Alcé de nuevo mis ojos y miré un rollo que volaba. 2. Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codos (9 m) y su anchura de 10 codos (4.5 m)." 3. Entonces me dijo: "Esta es la maldición que sale sobre la superficie de toda la tierra. Ciertamente todo el que roba será destruido según lo escrito en un lado, y todo el que jura será destruido según lo escrito en el otro lado. 4. "La haré salir," declara el SEÑOR de los ejércitos,"y entrará en casa del ladrón y en casa del que jura por Mi nombre en falso; y pasará la noche dentro de su casa y la consumirá junto con sus maderas y sus piedras." 5. Entonces el ángel que hablaba conmigo, salió y me dijo: "Alza ahora tus ojos y mira qué es esto que sale." 6. Y pregunté: "¿Qué es?" "Esto es el efa (una cesta de 22 litros) que sale," dijo él. Y añadió: "Esta es la iniquidad de ellos en toda la tierra." 7. "Entonces una tapa de plomo fue levantada, y había una mujer sentada dentro del efa (de la cesta). 8. Entonces dijo: "Esta es la Maldad." Y la arrojó al interior del efa (de la cesta) y arrojó la tapa de plomo sobre su abertura. 9. Luego alcé los ojos y miré dos mujeres que salían con el viento en sus alas. Tenían alas como alas de cigüeña, y alzaron el efa (la cesta) entre la tierra y el cielo. 10. Dije entonces al ángel que hablaba conmigo: "¿Adónde llevan el efa (la cesta)?" 11. Y él me respondió: "A la tierra de Sinar para edificarle un templo; y cuando esté preparado, será asentado allí sobre su base." http://bt3.me/gylg"><span class="icon-envelope-o"></span> SMS</a></li>
                              </ul>    
                             </div>
                        </div>
                    </div>  
...
?>                        <br />   
                        <h2 class="text-center"> Zacarías 5 - La Nueva Biblia Latinoamericana de Hoy</h2>          
                                                    <h4><strong>El rollo volante</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">1. </strong>Alcé de nuevo mis ojos y miré un rollo que volaba.</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">2. </strong>Y el ángel me dijo: "¿Qué ves?" Y respondí: "Veo un rollo que vuela; su longitud es de 20 codos (9 m) y su anchura de 10 codos (4.5 m)."</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">3. </strong>Entonces me dijo: "Esta es la maldición que sale sobre la superficie de toda la tierra. Ciertamente todo el que roba será destruido según lo escrito en un lado, y todo el que jura será destruido según lo escrito en el otro lado.</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">4. </strong>"La haré salir," declara el SEÑOR de los ejércitos,"y entrará en casa del ladrón y en casa del que jura por Mi nombre en falso; y pasará la noche dentro de su casa y la consumirá junto con sus maderas y sus piedras."</p>
                                                    <h4><strong>La mujer en el efa</strong></h4>                            <p style="style=text-align: justify;"><strong id="numeros">5. </strong>Entonces el ángel que hablaba conmigo, salió y me dijo: "Alza ahora tus ojos y mira qué es esto que sale."</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">6. </strong>Y pregunté: "¿Qué es?" "Esto es el efa (una cesta de 22 litros) que sale," dijo él. Y añadió: "Esta es la iniquidad de ellos en toda la tierra."</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">7. </strong>"Entonces una tapa de plomo fue levantada, y había una mujer sentada dentro del efa (de la cesta).</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">8. </strong>Entonces dijo: "Esta es la Maldad." Y la arrojó al interior del efa (de la cesta) y arrojó la tapa de plomo sobre su abertura.</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">9. </strong>Luego alcé los ojos y miré dos mujeres que salían con el viento en sus alas. Tenían alas como alas de cigüeña, y alzaron el efa (la cesta) entre la tierra y el cielo.</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">10. </strong>Dije entonces al ángel que hablaba conmigo: "¿Adónde llevan el efa (la cesta)?"</p>
                                                                                <p style="style=text-align: justify;"><strong id="numeros">11. </strong>Y él me respondió: "A la tierra de Sinar para edificarle un templo; y cuando esté preparado, será asentado allí sobre su base."</p>
                ...
                <td class="table_cap" title="Zacarías 6" onCLick="document.location='zacarias-6.php'">
                    <div data-sticky-container>
                        <div class="sticky" data-sticky data-options="marginTop:15;" data-sticky-on="small" data-anchor="cuadro">
                            <a href="zacarias-6.php" title="Zacarías 6"><span class="icon-chevron-right"></span></a>
                       </div> 
                    </div>                      
                </td>
             </tr>               
