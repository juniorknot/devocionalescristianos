...
<meta property="og:title" content="Deuteronomio 13 TLA - Traducción en Lenguaje Actual"/>
<meta property="og:description" content="Capítulo »Si algún profeta viene y les dice que tuvo una visión, o les anuncia que algo milagroso está por suceder,y el milagro realmente sucede, tengan cuidado. Si luego los invita a adorar a otros dioses desconocidos, - Traducción en Lenguaje Actual"/>
...
.com">
<meta name="twitter:title" content="Deuteronomio 13 TLA - Traducción en Lenguaje Actual">
<meta name="twitter:description" content="Capítulo »Si algún profeta viene y les dice que tuvo una visión, o les anuncia que algo milagroso está por suceder,y el milagro realmente sucede, tengan cuidado. Si luego los invita a adorar a otros dioses desconocidos, - Traducción en Lenguaje Actual">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo »Si algún profeta viene y les dice que tuvo una visión, o les anuncia que algo milagroso está por suceder,y el milagro realmente sucede, tengan cuidado. Si luego los invita a adorar a otros dioses desconocidos, - Traducción en Lenguaje Actual" name="description"/>
<?php } ?>

<!-- /la-biblia/Traduccion-lenguaje-actual/deuteronomio-13 , Wed, 28 Dec 2016 21:08:50 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo »Si algún profeta viene y les dice que tuvo una visión, o les anuncia que algo milagroso está por suceder,y el milagro realmente sucede, tengan cuidado. Si luego los invita a adorar a otros dioses desconocidos, - Traducción en Lenguaje Actual",
  "url": "../../la-biblia/Traduccion-lenguaje-actual/deuteronomio-13",
...
?><br/>
<h2 class="text-center"> Deuteronomio 13 - Traducción en Lenguaje Actual</h2>
<p style="style=text-align: justify;"><strong id="numeros">1. </strong>
»Si algún profeta viene y les dice que tuvo una visión, o les anuncia que algo milagroso está por suceder, </p>
<p style="style=text-align: justify;"><strong id="numeros">2. </strong>
y el milagro realmente sucede, tengan cuidado. Si luego los invita a adorar a otros dioses desconocidos, </p>
<p style="style=text-align: justify;"><strong id="numeros">3. </strong>
no le hagan caso. En realidad, Dios quiere ponerlos a prueba y ver si lo aman con todo lo que piensan y con todo lo que son. </p>
<p style="style=text-align: justify;"><strong id="numeros">4. </strong>
Ustedes deben adorar únicamente a su Dios, y sólo a él deben obedecerlo y serle fieles. </p>
<p style="style=text-align: justify;"><strong id="numeros">5. </strong>
En cuanto a ese falso profeta, deberán condenarlo a muerte, pues intentó hacer que desobedecieran a Dios. Así eliminarán el mal que haya entre ustedes. Fue nuestro Dios quien los liberó cuando ustedes eran esclavos en Egipto, así que sólo a él deben obedecerlo. </p>
<p style="style=text-align: justify;"><strong id="numeros">6. </strong>
»Si alguien los invita a adorar a otros dioses, cercanos o lejanos, no acepten esa invitación. Al contrario, deberán condenar a muerte a esa persona y ser los primeros en quitarle la vida. No le tengan compasión, no importa que sea su propio hermano, su hijo o su hija, y hasta su esposa o su mejor amigo. No le perdonen la falta, sino maten a pedradas a esa persona. Eso es lo que se merece cualquiera que trate de alejarlos del Dios de Israel, que fue quien los sacó de Egipto y les dio la libertad. Así le darán un buen ejemplo a todo el pueblo, que sentirá temor y no volverá a cometer tal pecado. </p>
