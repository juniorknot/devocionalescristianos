...
<meta property="og:title" content="Isaías 4 LXX - Biblia Septuaginta al Español"/>
<meta property="og:description" content="Capítulo Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado sobre nosotras; quita nuestro oprobio(a) .Y en aquel día centelleará Dios en consejo, con gloria, sobre la tierra, para exaltar y glorificar lo quedado de Israel. - Biblia Septuaginta al Español"/>
...
.com">
<meta name="twitter:title" content="Isaías 4 LXX - Biblia Septuaginta al Español">
<meta name="twitter:description" content="Capítulo Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado sobre nosotras; quita nuestro oprobio(a) .Y en aquel día centelleará Dios en consejo, con gloria, sobre la tierra, para exaltar y glorificar lo quedado de Israel. - Biblia Septuaginta al Español">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado sobre nosotras; quita nuestro oprobio(a) .Y en aquel día centelleará Dios en consejo, con gloria, sobre la tierra, para exaltar y glorificar lo quedado de Israel. - Biblia Septuaginta al Español" name="description"/>
<?php } ?>

<!-- /la-biblia/Version-septuaginta/isaias-4 , Wed, 28 Dec 2016 16:40:19 GMT -->
<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" lang='es'>

<!-- /la-biblia/Version-septuaginta/isaias-4 , Wed, 28 Dec 2016 16:40:18 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado sobre nosotras; quita nuestro oprobio(a) .Y en aquel día centelleará Dios en consejo, con gloria, sobre la tierra, para exaltar y glorificar lo quedado de Israel. - Biblia Septuaginta al Español",
  "url": "../../la-biblia/Version-septuaginta/isaias-4",
...
<li title="PDF de Isaías 4"><a title="PDF de Isaías 4" target="_blank" href="../../imprimir/Version-septuaginta/isaias-4.pdf"><span class="icon-file-pdf-o"></span></a></li>
<li title="Comentario Bíblico de Isaías 4"><a href="../../comentario-biblico/?v=LXX&amp;co=matthew-henry&amp;l=isaias&amp;cap=4" target="_blank"><span class="icon-book"></span></a></li>
<li id="shareButtonPrint" title="Imprimir Isaías 4"><a target="_blank" onclick='PrintElem("Isaias_4_Biblia Septuaginta al Espa\u00f1ol")' class="icon-print"></a></li>
</ul>
<ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden">
 
<li class="hide-for-large"><a href="whatsapp://send?text=Isaías 4 (LXX)%0A%0A 1. Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado sobre nosotras; quita nuestro oprobio(a) . 2. Y en aquel día centelleará Dios en consejo, con gloria, sobre la tierra, para exaltar y glorificar lo quedado de Israel. 3. Y será: lo quedado en Sión y lo quedado en Jerusalén; —santos serán llamados todos los escritos, para la vida, en Jerusalén». 4. Pues lavará el Señor la inmundicia de los hijos y de las hijas de Jerusalén; y la sangre purificará de en medio de ellos; en espíritu de juicio y espíritu de combustión. 5. Y vendrá; y será: todo(b)  lugar del monte Sión— y sobre todo lo en torno de ella sombreará nube, de día; y, cual de humo y lumbre de fuego ardiente, de noche; y por toda la gloria será protegida. 6. Y será para sombra, del ardor, y, en protección y en ocultamiento de rigor y lluvia.... %0A%0Ahttp://bt3.me/bi0K"><span class="icon-whatsapp"></span> WHATSAPP</a></li>
<li class="hide-for-large"><a href="bbmi://api/share?message=devocionales
&userCustomMessage=Isaías 4 (LXX)%0A%0A
 Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado... %0A%0Ahttp://bt3.me/bi0K"><span class="icon-group"></span> BLACKBERRY</a></li>
<li class="hide-for-large"><a href="sms:?&body=Isaías 4 LXX - Biblia Septuaginta al Español%0A%0A 1. Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado sobre nosotras; quita nuestro oprobio(a) . 2. Y en aquel día centelleará Dios en consejo, con gloria, sobre la tierra, para exaltar y glorificar lo quedado de Israel. 3. Y será: lo quedado en Sión y lo quedado en Jerusalén; —santos serán llamados todos los escritos, para la vida, en Jerusalén». 4. Pues lavará el Señor la inmundicia de los hijos y de las hijas de Jerusalén; y la sangre purificará de en medio de ellos; en espíritu de juicio y espíritu de combustión. 5. Y vendrá; y será: todo(b)  lugar del monte Sión— y sobre todo lo en torno de ella sombreará nube, de día; y, cual de humo y lumbre de fuego ardiente, de noche; y por toda la gloria será protegida. 6. Y será para sombra, del ardor, y, en protección y en ocultamiento de rigor y lluvia. http://bt3.me/bi0K"><span class="icon-envelope-o"></span> SMS</a></li>
</ul>
</div>
</div>
</div>
...
?><br/>
<h2 class="text-center"> Isaías 4 - Biblia Septuaginta al Español</h2>
<p style="style=text-align: justify;"><strong id="numeros">1. </strong>
Y cogerán siete mujeres a hombre uno, diciendo: «Nuestro pan comeremos, y nuestros vestidos nos pondremos; sólo que el nombre el tuyo sea llamado sobre nosotras; quita nuestro oprobio(a) . </p>
<h4><strong>Futuro glorioso de Jerusalén</strong></h4> <p style="style=text-align: justify;"><strong id="numeros">2. </strong>
Y en aquel día centelleará Dios en consejo, con gloria, sobre la tierra, para exaltar y glorificar lo quedado de Israel. </p>
<p style="style=text-align: justify;"><strong id="numeros">3. </strong>
Y será: lo quedado en Sión y lo quedado en Jerusalén; —santos serán llamados todos los escritos, para la vida, en Jerusalén». </p>
<p style="style=text-align: justify;"><strong id="numeros">4. </strong>
Pues lavará el Señor la inmundicia de los hijos y de las hijas de Jerusalén; y la sangre purificará de en medio de ellos; en espíritu de juicio y espíritu de combustión. </p>
<p style="style=text-align: justify;"><strong id="numeros">5. </strong>
Y vendrá; y será: todo(b) lugar del monte Sión— y sobre todo lo en torno de ella sombreará nube, de día; y, cual de humo y lumbre de fuego ardiente, de noche; y por toda la gloria será protegida. </p>
