...
<meta property="og:title" content="Salmos 122 TNM - Traducción del Nuevo Mundo (Testigos de Jehová)"/>
<meta property="og:description" content="Capítulo (Canción de las Subidas. De David.)
 Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”.Nuestros pies resultaron estar plantados dentro de tus puertas, oh Jerusalén. - Traducción del Nuevo Mundo (Testigos de Jehová)"/>
...
.com">
<meta name="twitter:title" content="Salmos 122 TNM - Traducción del Nuevo Mundo (Testigos de Jehová)">
<meta name="twitter:description" content="Capítulo (Canción de las Subidas. De David.)
 Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”.Nuestros pies resultaron estar plantados dentro de tus puertas, oh Jerusalén. - Traducción del Nuevo Mundo (Testigos de Jehová)">
<meta property="twitter:image" content="https://www.devocionalescristianos.org/biblia/assets/img/social/social_logo.jpg">
<meta content="Capítulo (Canción de las Subidas. De David.)
 Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”.Nuestros pies resultaron estar plantados dentro de tus puertas, oh Jerusalén. - Traducción del Nuevo Mundo (Testigos de Jehová)" name="description"/>
<?php } ?>

<!-- /la-biblia/Nuevo-mundo-testigos-de-jehova/salmos-122 , Wed, 28 Dec 2016 23:19:26 GMT -->
<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" lang='es'>

<!-- /la-biblia/Nuevo-mundo-testigos-de-jehova/salmos-122 , Wed, 28 Dec 2016 23:19:25 GMT -->
...
</div> <script type="application/ld+json">
{
  ...
  "description": "Capítulo (Canción de las Subidas. De David.)
 Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”.Nuestros pies resultaron estar plantados dentro de tus puertas, oh Jerusalén. - Traducción del Nuevo Mundo (Testigos de Jehová)",
  "url": "../../la-biblia/Nuevo-mundo-testigos-de-jehova/salmos-122",
  "image": "../../assets/img/thumbs/capitulo/salmos-122.jpg",
  "thumbnailUrl": "../../assets/img/thumbs/capitulo/salmos-122.jpg"
}
</script>
<div class="row">
...
<tr>
<td class="table_cap" title="Salmos 121" onCLick="document.location='salmos-121.php'">
<div data-sticky-container>
<div class="sticky" data-sticky data-options="marginTop:15;" data-sticky-on="small" data-anchor="caja">
<a href="salmos-121.php" title="Salmos 121"><span class="icon-chevron-left"></span></a>
</div>
</div>
</td>
...
<li title="Compartir Salmos 122" data-toggle="share-callout"> </li>
<li title="PDF de Salmos 122"><a title="PDF de Salmos 122" target="_blank" href="../../imprimir/Nuevo-mundo-testigos-de-jehova/salmos-122.pdf"><span class="icon-file-pdf-o"></span></a></li>
<li title="Comentario Bíblico de Salmos 122"><a href="../../comentario-biblico/?v=TNM&amp;co=matthew-henry&amp;l=salmos&amp;cap=122" target="_blank"><span class="icon-book"></span></a></li>
<li id="shareButtonPrint" title="Imprimir Salmos 122"><a target="_blank" onclick='PrintElem("Salmos_122_Traducci\u00f3n del Nuevo Mundo (Testigos de Jehov\u00e1)")' class="icon-print"></a></li>
</ul>
<ul class="callout small-3 column end is-hidden" id="share-callout" data-toggler="is-hidden">
 
<li class="hide-for-large"><a href="whatsapp://send?text=Salmos 122 (TNM)%0A%0A 1. (Canción de las Subidas. De David.)
 Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”. 2. Nuestros pies resultaron estar plantados dentro de tus puertas, oh Jerusalén. 3. Jerusalén es una que está edificada como ciudad que ha sido bien trabada en unidad, 4. a la cual han subido las tribus, las tribus de Jah, como recordatorio a Israel para dar gracias al nombre de Jehová. 5. Porque allí han estado asentados los tronos para juicio, tronos para la casa de David. 6. Pidan la paz de Jerusalén.  Los que te aman, [oh ciudad,] estarán libres de cuidado. 7. Continúe la paz dentro de tu antemural, la libertad de cuidado dentro de tus torres de habitación. 8. Por amor a mis hermanos y mis compañeros ciertamente hablaré ahora: “Haya paz dentro de ti”. 9. Por amor de la casa de Jehová nuestro Dios ciertamente seguiré buscando el bien para ti.... %0A%0Ahttp://bt3.me/jWW"><span class="icon-whatsapp"></span> WHATSAPP</a></li>
<li class="hide-for-large"><a href="bbmi://api/share?message=devocionales
&userCustomMessage=Salmos 122 (TNM)%0A%0A
(Canción de las Subidas. De David.)
 Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”.
Nuestros pies resultaron estar pl... %0A%0Ahttp://bt3.me/jWW"><span class="icon-group"></span> BLACKBERRY</a></li>
<li class="hide-for-large"><a href="sms:?&body=Salmos 122 TNM - Traducción del Nuevo Mundo (Testigos de Jehová)%0A%0A 1. (Canción de las Subidas. De David.)
 Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”. 2. Nuestros pies resultaron estar plantados dentro de tus puertas, oh Jerusalén. 3. Jerusalén es una que está edificada como ciudad que ha sido bien trabada en unidad, 4. a la cual han subido las tribus, las tribus de Jah, como recordatorio a Israel para dar gracias al nombre de Jehová. 5. Porque allí han estado asentados los tronos para juicio, tronos para la casa de David. 6. Pidan la paz de Jerusalén.  Los que te aman, [oh ciudad,] estarán libres de cuidado. 7. Continúe la paz dentro de tu antemural, la libertad de cuidado dentro de tus torres de habitación. 8. Por amor a mis hermanos y mis compañeros ciertamente hablaré ahora: “Haya paz dentro de ti”. 9. Por amor de la casa de Jehová nuestro Dios ciertamente seguiré buscando el bien para ti. http://bt3.me/jWW"><span class="icon-envelope-o"></span> SMS</a></li>
</ul>
</div>
</div>
</div>
...
?><br/>
<h2 class="text-center"> Salmos 122 - Traducción del Nuevo Mundo (Testigos de Jehová)</h2>
<h4><strong>Oración por la paz de Jerusalén
Cántico gradual; de David.</strong></h4> <p style="style=text-align: justify;"><strong id="numeros">1. </strong>
(Canción de las Subidas. De David.)
Me regocijé cuando estuvieron diciéndome: “Vamos a la casa de Jehová”.</p>
<p style="style=text-align: justify;"><strong id="numeros">2. </strong>
Nuestros pies resultaron estar plantados dentro de tus puertas, oh Jerusalén.</p>
<p style="style=text-align: justify;"><strong id="numeros">3. </strong>
Jerusalén es una que está edificada como ciudad que ha sido bien trabada en unidad,</p>
<p style="style=text-align: justify;"><strong id="numeros">4. </strong>
a la cual han subido las tribus, las tribus de Jah, como recordatorio a Israel para dar gracias al nombre de Jehová.</p>
<p style="style=text-align: justify;"><strong id="numeros">5. </strong>
Porque allí han estado asentados los tronos para juicio, tronos para la casa de David.</p>
<p style="style=text-align: justify;"><strong id="numeros">6. </strong>
Pidan la paz de Jerusalén. Los que te aman, [oh ciudad,] estarán libres de cuidado.</p>
<p style="style=text-align: justify;"><strong id="numeros">7. </strong>
Continúe la paz dentro de tu antemural, la libertad de cuidado dentro de tus torres de habitación.</p>
<p style="style=text-align: justify;"><strong id="numeros">8. </strong>
Por amor a mis hermanos y mis compañeros ciertamente hablaré ahora: “Haya paz dentro de ti”.</p>
<p style="style=text-align: justify;"><strong id="numeros">9. </strong>
Por amor de la casa de Jehová nuestro Dios ciertamente seguiré buscando el bien para ti.</p>
</div>
</td>
<td class="table_cap" title="Salmos 123" onCLick="document.location='salmos-123.php'">
<div data-sticky-container>
<div class="sticky" data-sticky data-options="marginTop:15;" data-sticky-on="small" data-anchor="cuadro">
<a href="salmos-123.php" title="Salmos 123"><span class="icon-chevron-right"></span></a>
</div>
</div>
</td>
</tr>
